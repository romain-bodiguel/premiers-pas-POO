                    ...
                    <div class="card-body">
                        ...
                        <p class="infos">
                            Posté par <a href="#" class="card-link">
                                <?php echo $articleObject->author ; ?>
                            </a> le <time datetime="<?php echo $articleObject->date ; ?>"><?php echo $articleObject->getDateFr() ; ?></time> dans <a href="#" class="card-link">#<?php echo $articleObject->category ; ?></a>
                        </p>
                    </div>
                </article>
            <?php endforeach; ?>
